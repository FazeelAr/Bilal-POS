    ...
    <div className="space-y-4 sm:space-y-6">
        ...
        <div className="sm:hidden bg-white rounded-xl p-4 border border-gray-200 shadow-lg">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className={`px-3 py-2 rounded-lg text-sm font-medium ${filter === "all"
            ...
            <button
              ...
              className={`px-3 py-2 rounded-lg text-sm font-medium ${filter === "positive"
            ...
            <button
              ...
              className={`px-3 py-2 rounded-lg text-sm font-medium ${filter === "negative"
            ...
            <button
              ...
              className={`px-3 py-2 rounded-lg text-sm font-medium ${filter === "zero"
        ...
        <div className="sm:hidden bg-white rounded-xl p-4 border border-gray-200 shadow-lg">
          ...
          <div className="space-y-2">
            <button
              ...
              className={`w-full px-3 py-2 rounded-lg text-sm font-medium flex items-center justify-between ${sortBy === "name"
            ...
            <button
              ...
              className={`w-full px-3 py-2 rounded-lg text-sm font-medium flex items-center justify-between ${sortBy === "balance"
                  ? "bg-blue-100 text-blue-700"
                  : "bg-gray-100 text-gray-700"
                }`}
            >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
        <div className="bg-linear-to-br from-purple-50 to-pink-50 rounded-xl p-3 sm:p-5 border border-purple-100">
          <p className="text-xs sm:text-sm font-medium text-gray-600 mb-1">Total Balance</p>
      ...
      <div className="hidden sm:block bg-white rounded-xl p-4 border border-gray-200">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              onClick={() => handleFilter("positive")}
              className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${filter === "positive"
                  ? "bg-red-100 text-red-700"
                  : "bg-gray-100 text-gray-700 hover:bg-gray-200"
                }`}
            >
            ...
            <button
              onClick={() => handleFilter("negative")}
              className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${filter === "negative"
                  ? "bg-green-100 text-green-700"
                  : "bg-gray-100 text-gray-700 hover:bg-gray-200"
                }`}
            >
            ...
            <button
              onClick={() => handleFilter("zero")}
              className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${filter === "zero"
                  ? "bg-gray-200 text-gray-800"
                  : "bg-gray-100 text-gray-700 hover:bg-gray-200"
                }`}
            >
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={() => handleSort("name")}
              className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors flex items-center gap-1 ${sortBy === "name"
                  ? "bg-blue-100 text-blue-700"
                  : "bg-gray-100 text-gray-700 hover:bg-gray-200"
                }`}
            >
            ...
            <button
              onClick={() => handleSort("balance")}
              className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors flex items-center gap-1 ${sortBy === "balance"
                  ? "bg-blue-100 text-blue-700"
                  : "bg-gray-100 text-gray-700 hover:bg-gray-200"
                }`}
            >
      ...
      {/* Filtered Summary */}
      {filter !== "all" && (
        <div className={`p-3 sm:p-4 rounded-xl border ${filter === "positive"
          ...
          <table className="w-full min-w-[640px] sm:min-w-0">
                ...
                filteredCustomers.map((customer) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-right">
                      <span className={`text-sm sm:text-lg font-bold ${customer.balance > 0
                          ? "text-red-600"
                          : customer.balance < 0
                            ? "text-green-600"
                            : "text-gray-600"
                    ...
                    <td className="py-3 px-4 text-center">
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${customer.balance > 0
            ...
            <tfoot>
              <tr className="bg-gray-50 border-t border-gray-200">
                ...
                <td className="py-3 px-4 text-right">
                  <span className={`text-lg sm:text-xl font-bold ${filteredTotal > 0 ? "text-red-600" : "text-green-600"
                    }`}
                  >
            ...
            {filteredCustomers.map((customer) => (
              ...
              >
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className={`text-lg font-bold ${customer.balance > 0
                      ? "text-red-600"
                      : customer.balance < 0
                        ? "text-green-600"
                        : "text-gray-600"
                ...
                <div className="flex items-center justify-between text-sm">
                  <div className="flex items-center gap-4">
                    ...
                    <span className={`px-2 py-0.5 rounded-full text-xs ${customer.balance > 0
                        ? "bg-red-100 text-red-800"
                        : customer.balance < 0
                          ? "bg-green-100 text-green-800"
                          : "bg-gray-100 text-gray-800"
        ...
        <div className="space-y-2 sm:space-y-3">
          ...
          <div className="flex items-start gap-2 p-2 sm:p-3 bg-blue-50 rounded-lg">
            ...
            <p className="text-xs sm:text-sm text-blue-700">
              <span className="font-semibold">Tip:</span> Monitor balances regularly for healthy cash flow.
            </p>
          </div>
        </div>
      </div>
