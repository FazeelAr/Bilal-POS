...
import { FileText, ChevronRight, Home, ShoppingCart, BarChart3, Users } from "lucide-react";
...
function Header() {
  ...
  if (location.pathname === "/receipt" || location.pathname === "/" || location.pathname === "/login") {
    return null;
  }
