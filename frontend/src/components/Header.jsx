...
function Header() {
  ...
  return (
    <header className="bg-linear-to-r from-purple-600 via-pink-500 to-rose-500 shadow-xl relative overflow-hidden">
      {/* Decorative background elements - hide on mobile for performance */}
      ...
      {isMenuOpen && (
        <div className="sm:hidden fixed inset-0 top-16 bg-black/50 z-40" onClick={() => setIsMenuOpen(false)}>
